...
class COINMFuturesClient:
    def __init__(self, http_client: UnifiedHTTPClient):
        ...
        self.market_type = MarketType.COINM_FUTURES

    async def get_account_info(self) -> AccountInfo:
        result = await self.http.get("/dapi/v1/account", signed=True)
    ...
    async def get_exchange_info(self) -> dict:
        result = await self.http.get("/dapi/v1/exchangeInfo")
        return result

    async def get_ticker(self, symbol: str) -> Ticker:
        result = await self.http.get("/dapi/v1/ticker/24hr", params={"symbol": symbol})
    ...
    async def get_klines(
        ...
        klines = await self.http.get("/dapi/v1/klines", params=params)
    ...
    async def place_order(
        ...
        result = await self.http.post("/dapi/v1/order", params=params, signed=True)
    ...
    async def cancel_order(
        ...
        result = await self.http.delete("/dapi/v1/order", params=params, signed=True)
    ...
    async def get_order(
        ...
        result = await self.http.get("/dapi/v1/order", params=params, signed=True)
    ...
    async def get_open_orders(self, symbol: Optional[str] = None) -> list[OrderResponse]:
        ...
        results = await self.http.get("/dapi/v1/openOrders", params=params, signed=True)
    ...
    async def set_leverage(self, symbol: str, leverage: int) -> dict:
        ...
        result = await self.http.post("/dapi/v1/leverage", params=params, signed=True)
        return result
    ...
    async def set_margin_type(self, symbol: str, margin_type: Literal["ISOLATED", "CROSSED"]) -> dict:
        ...
        result = await self.http.post("/dapi/v1/marginType", params=params, signed=True)
        return result
    ...
    async def change_position_mode(self, dual_side_position: bool) -> dict:
        ...
        result = await self.http.post("/dapi/v1/positionSide/dual", params=params, signed=True)
        return result
